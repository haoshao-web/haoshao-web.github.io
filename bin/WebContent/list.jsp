    ...
    <div style="float: left;">
        ...
        <form class="form-inline" action="${pageContext.request.contextPath}/findUserByPageServlet" method="post">
            <div class="form-group">
                <label for="exampleInputName2">图书编号</label>
                <input type="text" name="bookid" value="${condition.bookid[0]}" class="form-control" id="exampleInputName2" >
            </div>

            <div class="form-group">
                <label for="exampleInputEmail2">图书类型</label>
                <input type="text" name="type" value="${condition.type[0]}" class="form-control" id="exampleInputEmail2"  >
            </div>
